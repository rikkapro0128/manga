<template>
  <div v-if="!cachedDone.length">
    <Spiner color="#4F46E5" message="đang tải hình ảnh bạn đợi xíu nha..." />
  </div>
  <div v-else>
    <div class="flex justify-center lg:w-4/5 m-auto relative" v-for="(story, index) in cachedDone" :key="story">
      <div
...
const storys = reactive([
  ...
  'https://i.ibb.co/Wsc5b5Js/10.jpg', //
  ...
  'https://i.ibb.co/KzNXF0Fs/17.jpg', //
